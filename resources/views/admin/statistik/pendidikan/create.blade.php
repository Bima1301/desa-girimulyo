...
<div class="container">
    <div class="row">
        <div class="col mx-lg-5 mt-lg-5">
            <h1>Create New Data Pendidikan</h1>
            ...
            <form method="post" action="/dashboard/datapendidikan">
                @csrf   
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary">Create Data Pendidikan</button>
              </form>
