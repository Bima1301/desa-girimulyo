    ...
    <div class="row">
        <div class="col mx-lg-5 mt-lg-5">
            ...
            <form method="post" action="/dashboard/perangkat" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-primary">Create Perangkat</button>
              </form>
